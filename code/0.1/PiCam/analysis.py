...
DATASET_PATH = os.getcwd()+'/classifications.txt'  # the dataset file or root folder path.

# Image Parameters
N_CLASSES = 3          # total number of classes
IMG_HEIGHT = 971       # image height to be resized to
IMG_WIDTH = 1020       # image width to be resized to
CHANNELS = 1           # 3 color channels
...
with tf.Session() as sess:
    ...
    # Save your model
    saver.save(sess, 'picam_tf_model')
